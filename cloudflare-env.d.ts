/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 705a976132a189b58771372bba715ce8)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DOCUMENTS: R2Bucket;
	ASSETS: Fetcher;
	LOCAL_LLM_BASE_URL: "https://local-rag-llm.amirkatamachi.com/v1";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOCAL_LLM_BASE_URL" | "LOCAL_LLM_MODEL" | "VECTOR_SEARCH_ENABLED">> {}
}
